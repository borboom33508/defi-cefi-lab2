...
describe("Question 2 :", function () {
  it("should liquidate with 2000 USDT", async function () {
    ...
    console.log(
      `${usdtValue/1000000} USDT liquidation profit is`,
  ...
  it("should liquidate with 5000 USDT", async function () {
    ...
    const profits = afterLiquidationBalance.sub(beforeLiquidationBalance);
    console.log(
      `${usdtValue/1000000} USDT liquidation profit is`,
      utils.formatEther(profits),
      "ETH"
    );

    expect(profits.gt(BigNumber.from(0)), "not profitable").to.be.true;
    console.log("###############################################################################################################");
  });
  it("Liquidate should not 10000 USDT", async function () {
    console.log(
      "\n Liquidation 10000 USDT"
    );
    await network.provider.request({
      method: "hardhat_reset",
      params: [
